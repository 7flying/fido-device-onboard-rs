...
enum Commands {
    ...
    ImportOwnershipVoucher(ImportOwnershipVoucherArguments),
}
...
#[derive(Args)]
struct ImportOwnershipVoucherArguments {
...
async fn main() -> Result<()> {
    ...
    match Cli::parse().command {
        ...
        Commands::ImportOwnershipVoucher(args) => import_ownership_voucher(&args),
    }
}
...
fn import_ownership_voucher(args: &ImportOwnershipVoucherArguments) -> Result<()> {
